...
export const PROJECTS = [
  {
    title: "Chatty",
    description: `Experience a new standard of connectivity with this 'MERN Cloud Messenger' a robust demonstration of our architecture, state management, and DevOps skills. Engineered with WebRTC and powered by Redis, this app is more than simple chat application. It is a live environment featuring scalable audio calls and real-time presence deployed on AWS EC2.`,
